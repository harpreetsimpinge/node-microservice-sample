...
// Articles controller
angular.module('articles').controller('articleActionController', ['$scope', '$state', '$location', '$timeout', 'Articles', '$http', 'Authentication', 'FileUploader', 'toastr', '$filter', '$window', 'ngDialog', 'fileUpload', '$sce', '$rootScope',
  function($scope, $state, $location, $timeout, Articles, $http, Authentication, FileUploader, toastr, $filter, $window, ngDialog, fileUpload, $sce, $rootScope) {
    ...
    $scope.sendEditArticle = function(isValid) {
      ...
      console.log("Edit article when note add");
    ...
    $scope.searchAndDisplay = function() {
      console.log("Notes for article", $scope.notesUnfilter);
